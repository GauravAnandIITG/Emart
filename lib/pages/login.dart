          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: TextField(decoration: InputDecoration(hintText: "Enter your Email",border: InputBorder.none, hintStyle: AppWidget.lightStyle(),prefixIcon: Icon(Icons.mail)),)
              ),
              SizedBox(height:10,),
              ...
              Container(
                padding: EdgeInsets.only(left: 10),
                decoration: BoxDecoration(color: Colors.grey[300],borderRadius: BorderRadius.circular(10) ),
                child: TextField(decoration: InputDecoration(hintText: "Enter Password",border: InputBorder.none, hintStyle: AppWidget.lightStyle(),prefixIcon: Icon(Icons.password)))
              ),
              SizedBox(height:5,),
              Row(
